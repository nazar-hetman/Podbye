...
_CATEGORY_BY_TYPE = {
    ...
    # Databases & Saves
    "database": "Databases & Saves",
    "game_saves": "Databases & Saves",
...
class SmartEntity:
    ...
    def category(self) -> str:
        """Map entity type to a display category for filter chips.

        See _CATEGORY_BY_TYPE (module level) for the full mapping.
        """
